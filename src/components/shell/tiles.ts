...
// is the wide 2x1 hero across the top; the eight tools sit below it in a two-column
...
// The eight tool tiles, in grid order (they fill the two columns below the hero).
export const TOOL_TILES: Tile[] = [
  ...
  { key: 'followups', label: 'Follow-Ups', icon: ClipboardList, route: '/staff/requests', active: 'bg-rose-600 text-white border-rose-600', idleIcon: 'text-rose-600 dark:text-rose-400', tint: 'bg-rose-500/10', enabled: true },
